...
void mayin_yerlestir()
{
    ...
    {
        mayin_kolon=2+rand()%(Tarla_boyutu-4);
        mayin_satir=2+rand()%(Tarla_boyutu-4);
...
void arastirma(int satir,int kolon)//okey
{
...
int kazici(int satir,int kolon)//okey
{
    int durum=0;
